...
namespace Control
{
	/* CharacterController2D from Prime31 on GitHub https://github.com/prime31/CharacterController2D
	 * Used under license Attribution-NonCommercial-ShareAlike 3.0 Unported with simple explanation.
	 * "You are free to use the CharacterController2D in any and all games that you make. You cannot
	 * sell the CharacterController2D directly or as part of a larger game asset."
	 *
	 * Slightly modified for my own readability/coding conventions, added to my namespace, will remove
	 * above licensing if altered more than 75% to meet requirements for my game design.
	 */
	...
	public class CharacterController2D : MonoBehaviour
	{
		...
		void MoveVertically( ref Vector3 deltaMovement )
		{
			...
			var rayDistance = Mathf.Abs( deltaMovement.y ) + skinWidth + 0.1f;                           // (0.1f) Custom, fix glitch when collider size changes due to sprite size changes... may need to change sprite anchor?
